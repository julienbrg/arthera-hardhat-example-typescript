...
const subscriberContractAddress = "0x000000000000000000000000000000000000Aa07"
const subscriberContractAbi = [
  {
    "inputs": [],
...
async function whitelist() {
  ...
  const keitaContractAddress = "0x509779185445f453C8eF59e3091d2bD197ADba9d" // Replace with your contract address
  ...
  console.log("subscriberContractAddress:", subscriberContractAddress)

  const subscriberContract = new ethers.Contract(subscriberContractAddress, subscriberContractAbi, signer)
  ...
  const alice = "0x02bC12dAc51024f330fc79bFD651f66946aeF974"
  // const alice = "0xE45079d379712E51408B00496D232407D9449F79"
  // const alice = "0xbFBaa5a59e3b6c06afF9c975092B8705f804Fa1c" // Satoshi
  // const alice = signerAddress // signerAddress
  
  ///// call /////

  // const wl = await subscriberContract.blacklistAccount(happyUser)
  const wl = await subscriberContract.whitelistAccount(alice)
  await wl.wait(1)

  const whitelistTx = await subscriberContract.isWhitelisted(keitaContractAddress, alice)
  console.log("Alice is whitelisted:", whitelistTx)
